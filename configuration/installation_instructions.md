To generate a token, you can check the following [documentation](https://docs.sonarsource.com/sonarqube-cloud/managing-your-account/managing-tokens/). For SonarQube Server, it should be a USER token.
